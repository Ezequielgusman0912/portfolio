    ...
    context = {
        "profile": {
            ...
            "summary": (
                ...
                "backend, analisis funcional e infraestructura cloud. Desarrollo "
                "ecosistemas con Python, Django, Azure, MySQL, WebSockets e "
                "integraciones IoT para flujos de datos de alta disponibilidad."
            ),
        },
        "highlights": [
